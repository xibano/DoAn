...
if (!empty($_POST['ten']) && !empty($_POST['email'])) {
  $query = "INSERT INTO tai_khoan (id,ten,email,mat_khau,vai_tro) VALUES (?,?, ?, ?,?)";
  ...
  $query = "DELETE FROM tai_khoan WHERE id= ? ";
    ...
    <div class="container-fluid">
      ...
      <div class="row">
          ...
          <div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10" style="border: none" >
            ...
            <h1 class="mt-5 mb-4 text-center">Quản lý tài khoản</h1>
            <div class="mx-auto" style="width: 85%">
              <form class="mb-3 mt-3 d-inline" role="search">
                <a href="Themtaikhoanadmin.php"><button class="btn btn-outline-success" type="button">Thêm tài khoản admin</button></a>
                &nbsp; &nbsp;
                <!--<div class="dropdown">
                ...
                <form class="d-inline float-end w-50" action="Admin_user.php">
              ...
              <table class="table">
                  ...
                  <?php
                      ...
                      if(isset($_GET["search"])) {
                        $query .= " WHERE tai_khoan.ten LIKE '%" . $_GET['search']. "%'";
                      }
                      try {
                        $sth = $pdo->query($query);
                        while($row = $sth->fetch()) {
                          ...
                          <td>' . $row['vai_tro'] . '</td>
                          <td>
                              <a href="Suataikhoannguoidung.php?id=' . $row['id'] . '" class="text-light">
                              ...
                              <a href="Admin_user.php?id=' . $row['id'] . '" class="text-light">
