...
<html lang-="en">
  <head>
    ...
    <link rel="stylesheet" href="./css/style.css">
    <link rel="stylesheet" href="./css/Admin_quan.css">
    <title>Quản lý sản phẩm quần</title>
  </head>
  <body>
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10" style="border: none" >
          ...
          <h1 class="mt-5 mb-4 text-center">Quản lý sản phẩm quần</h1>
            ...
            <table class="table">
                ...
                <tbody>
                  <tr>
                    <th scope="row">1</th>
                    <td>Q1</td>
                    <td><a href="Admin_chitietsanpham.php" class="text-dark" style="text-decoration: none">Quần jeans xanh </a></td>
                    <td>Quần jeans</td>
                    <td>
                  ...
                  <tr>
                    <th scope="row">2</th>
                    <td>Q2</td>
                    <td><a href="" class="text-dark" style="text-decoration: none">Quần tây 1</a></td>
                    <td>Quần tây</td>
                    <td>
                        <a href="Ao.php" class="text-light">
                            <button type="button" class="btn btn-danger btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="edit item">
                  ...
                  <tr>
                    <th scope="row">3</th>
                    <td>Q3</td>
                    <td><a href="" class="text-dark" style="text-decoration: none">Quần short 2</a></td>
                    <td>Quần short</td>
                    <td>
                        <a href="Ao.php" class="text-light">
                            <button type="button" class="btn btn-danger btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="edit item">
                  ...
                  <tr>
                    <th scope="row">4</th>
                    <td>Q4</td>
                    <td><a href="" class="text-dark" style="text-decoration: none">Quần ống loe 1</a></td>
                    <td>Quần ống loe</td>
                    <td>
                        <a href="Ao.php" class="text-light">
                            <button type="button" class="btn btn-danger btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="edit item">
                  ...
                  <tr>
                    <th scope="row">5</th>
                    <td>Q5</td>
                    <td><a href="" class="text-dark" style="text-decoration: none">Quần tây đen</a></td>
                    <td>Quần tây</td>
                    <td>
                        <a href="Ao.php" class="text-light">
                            <button type="button" class="btn btn-danger btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="edit item">
