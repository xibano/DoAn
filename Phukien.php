...
<html lang-="en">
    ...
    <body>
        ...
        <h2 style="margin: 20px 0 10px 0">SẢN PHẨM PHỤ KIỆN</h2>
...
<div class="btn-group">
  ...
  <div class="btn-group">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="#" onClick="document.getElementById('menu-value-loaisanpham').innerHTML='Túi xách'">Túi xách</a></li>
        <li><a class="dropdown-item" href="#" onClick="document.getElementById('menu-value-loaisanpham').innerHTML='Mắt kính'">Mắt kính</a></li>
        ...
        <div class="container-fluid">
          <div class="row">
            <?php
              ...
              JOIN loai_san_pham lsp ON lctsp.id_lsp = lsp.id WHERE  lsp.id = 'LSP4';";
