...
<html lang-="en">
  <head>
    ...
    <link rel="stylesheet" href="./css/style.css">
    <link rel="stylesheet" href="./css/Admin_ao.css">
    <title>Quản lý sản phẩm áo</title>
  </head>
  <body>
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10" style="border: none" >
          ...
          <h1 class="mt-5 mb-4 text-center">Quản lý sản phẩm áo</h1>
            ...
            <table class="table">
                ...
                <tbody>
                  <tr>
                    <th scope="row">1</th>
                    <td>A1</td>
                    <td><a href="Admin_chitietsanpham.php" class="text-dark" style="text-decoration: none">Áo thun cổ tròn màu xanh dương</a></td>
                    <td>Áo thun</td>
                    <td>
                        <a href="Chitietsanpham.php" class="text-light">
                  ...
                  <tr>
                    <th scope="row">2</th>
                    <td>A2</td>
                    <td><a href="" class="text-dark" style="text-decoration: none">Áo sơ mi 2</a></td>
                    <td>Áo sơ mi</td>
                    <td>
                  ...
                  <tr>
                    <th scope="row">3</th>
                    <td>A3</td>
                    <td><a href="" class="text-dark" style="text-decoration: none">Áo polo xanh navi</a></td>
                    <td>Áo polo</td>
                    <td>
                        <a href="Ao.php" class="text-light">
                            <button type="button" class="btn btn-danger btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="edit item">
                  ...
                  <tr>
                    <th scope="row">4</th>
                    <td>A4</td>
                    <td><a href="" class="text-dark" style="text-decoration: none">Áo thun batman</a></td>
                    <td>Áo thun</td>
                    <td>
                        <a href="Ao.php" class="text-light">
                            <button type="button" class="btn btn-danger btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="edit item">
                  ...
                  <tr>
                    <th scope="row">5</th>
                    <td>A5</td>
                    <td><a href="" class="text-dark" style="text-decoration: none">Áo sơ mi tím rịm tìm sim</a></td>
                    <td>Áo sơ mi</td>
                    <td>
                        <a href="Ao.php" class="text-light">
                            <button type="button" class="btn btn-danger btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="edit item">
